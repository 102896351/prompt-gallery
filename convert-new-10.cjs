// Convert selected-10.json → TypeScript object literal fragments for prompts.ts
const fs = require('fs');
...
const picked = JSON.parse(fs.readFileSync('selected-10.json', 'utf8'));
...
const output = ',\n' + fragments.join(',\n') + '\n';
fs.writeFileSync('new-prompts-fragments.ts', output, 'utf8');
console.log('Generated', fragments.length, 'fragments →', 'new-prompts-fragments.ts');
